...
//import  static com.sarobotics.utils.TimeUtil.*;
...
//  public final static int ALL_LED_OFF_H = 0xFD;
  ...
  private PCA9685(int address) throws I2CFactory.UnsupportedBusNumberException {
    try {
      // Get I2C bus
...
//   * @param pulseMS in ms.
//   */
//  private void setServoPulse(int channel, float pulseMS) {
...
//    }
    ...
    final int DROP_SERVO_CHANNEL = 0;
...
//    inizializzaServoPerIlDrop(servoBoard,DROP_SERVO_CHANNEL,servoMin,servoMax);
//
//
//
//    releasePayLoad(servoBoard,DROP_SERVO_CHANNEL,servoMin,servoMax);
...
//    }
    ...
    //servoBoard.setPWM(CONTINUOUS_SERVO_CHANNEL, 0, 0); // Stop the continuous one
    servoBoard.setPWM(DROP_SERVO_CHANNEL, 0, 0);   // Stop the standard one
    System.out.println("Done with the demo.");
...
//    delay(4000);
    ...
    long ingresso = System.currentTimeMillis();
    ...
    Long uscita = System.currentTimeMillis();
